...
const Developer = ({ data }) => {
  return (
    <div className="flex gap-2 justify-center -mx-4">
      <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
        <div className="mb-10 wow fadeInUp" data-wow-delay=".1s">
          <div className="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
            <img src={data.image} alt="image" className="w-full rounded-full" />
      ...
      <div className="w-2/5">
        <p className="my-8 text-gray-700 text-[1rem]">{data.description}</p>
        <div className="items-center hidden gap-4 lg:flex">
          <a href={data.link}>
            <button
              type="button"
              className="flex items-center gap-2 bg-blue-500 hover:bg-blue-700 text-white font-semibold py-[0.4rem] px-8 rounded-md text-sm"
            >
              Portfolio{" "}
            </button>
          </a>
    ...
    <section id="team" className="mx-32 my-16">
      <div className="container">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          <div>
            <p className="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider uppercase rounded-full text-blue bg-teal-accent-400">
              About
            </p>
          </div>
        ...
        <>
          ...
          >
            <SwiperSlide>
              <Developer data={data[0]} />
            </SwiperSlide>
            <SwiperSlide>
              <Developer data={data[1]} />
            </SwiperSlide>
            <SwiperSlide>
              <Developer data={data[2]} />
            </SwiperSlide>
            <SwiperSlide>
              <Developer data={data[3]} />
            </SwiperSlide>
            <SwiperSlide>
              <Developer data={data[4]} />
            </SwiperSlide>
          </Swiper>
        </>
      </div>
