            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
              <div className="mb-10 wow fadeInUp" data-wow-delay=".1s">
                ...
                <div className="text-center">
                  <h4 className="mb-2 text-xl font-bold text-green-700">
                    {data.name}
                  </h4>
            ...
            <div className="w-2/5">
              ...
              <div className="items-center hidden gap-4 lg:flex">
                ...
                >
                   <button
      type='button'
      className="flex items-center gap-2 bg-green-500 hover:bg-green-700 text-white font-semibold py-[0.4rem] px-8 rounded-md text-sm">
Portfolio    </button>
                </a>
    ...
    <section id="team" className="mx-32 my-16">
        <div className="container">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            <div>
              <p className="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider uppercase rounded-full text-green bg-teal-accent-400">
                About
              </p>
            </div>
