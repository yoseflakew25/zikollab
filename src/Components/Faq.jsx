...
const Faq = () => {
  return (
    ...
    <details className="group [&_summary::-webkit-details-marker]:hidden" open>
      ...
      >
        <h2 className="font-medium text-green-800">What makes Fetena.com user-friendly for exam creation?</h2>
    ...
    <details className="group [&_summary::-webkit-details-marker]:hidden">
      <summary
        className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900"
      >
        <h2 className="font-medium text-green-800">How does Fetena.com ensure a secure exam environment?</h2>
    ...
    <details className="group [&_summary::-webkit-details-marker]:hidden" open>
      <summary
        className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900"
      >
        <h2 className="font-medium text-green-800">Can Fetena.com handle automated grading?</h2>
    ...
    <details className="group [&_summary::-webkit-details-marker]:hidden">
      <summary
        className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900"
      >
        <h2 className="font-medium text-green-800">What real-time monitoring capabilities does Fetena.com offer?</h2>
