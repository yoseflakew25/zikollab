...
const HeroSection = () => {
  return (
    <section className="flex justify-center items-center px-16 py-16 mt-12 bg-green-700 ">
        ...
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-center self-stretch pt-1.5 pr-6 pb-8 my-auto max-md:mt-16 max-md:max-w-full">
              ...
              Zikollab supports and monitors children’s nutritional recovery after hospital discharge. It streamlines tracking dietary intake, health progress, and care adjustments, helping ensure sustained recovery and reducing relapse risks.         </p>
              <div className="flex flex-wrap gap-2 items-center justify-center mt-8">
                <Link
                  to="/sign-in"
                  type="button"
                  className="transition duration-300 ease-in-out flex items-center gap-2 bg-transparent hover:bg-green-900 border text-white border-white font-semibold py-[0.4rem] px-16 rounded-md text-md"
                >
                  Get Started
                </Link>
                <a
                  href="#how-it-works"
                  type="button"
                  className="transition duration-300 ease-in-out flex items-center gap-2 bg-transparent hover:bg-green-900 text-white font-semibold py-[0.4rem] px-8 rounded-md text-md"
                >
