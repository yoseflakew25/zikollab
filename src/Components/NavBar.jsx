  ...
  return (
    <nav className={`bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200 ${
      ...
      <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
       ...
       <Link to="/" className="text-3xl font-bold text-green-800">Zikollab</Link>
        ...
        <div
          ...
          <ul className='flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg lg:bg-transparent md:space-x-8 md:flex-row md:mt-0 md:border-0 md:bg-white '>
            <li>
                     <Link
                to='/'
                className='block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-green-500 md:p-0 focus:text-green-500'>
                Home
              </Link>
            </li>
            <li>
