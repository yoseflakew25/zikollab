    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          "/api/exams?limit=4&fields=examName,organization&sort=-createdAt"
        );
    ...
    <div className="flex flex-col gap-4 my-2">
      ...
      <div>
        <Card style={{ width: "100%" }} tabProps={{ size: "middle" }}>
          <h1 className="text-xl font-bold text-blue-700 my-4 text-left">
            Related Exams
          </h1>
          ...
          <div className="text-right mt-4">
            <Link to="/dashboard/exams" className="text-blue-700 font-semibold">
              See more...
            </Link>
          </div>
        </Card>
