...
<>
    ...
    <h2 className="text-3xl font-bold leading-9 text-green-700 max-md:max-w-full text-left">
...
<article className="group flex flex-col justify-center items-start py-7 pr-12 pl-6 leading-5 text-black bg-gray-100 rounded-xl max-w-[304px] transition-all duration-300 hover:bg-green-700 hover:text-white hover:scale-105">
  <div className=" border aspect-square w-[55px] h-[55px] bg-green-700 rounded-full flex justify-center items-center text-white group-hover:border-white group-hover:text-white ">
