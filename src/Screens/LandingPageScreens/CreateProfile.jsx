                  ...
                  <div className="grid grid-cols-3 gap-2 items-center">
                    ...
                    <div className="flex flex-col gap-2 items-start">
                      ...
                      >
                        ...
                        <option value="returned-defaulter">
                          Returned Defaulter
                        </option>
              ...
              >
                <form className="flex flex-col gap-4">
                  <div className="grid grid-cols-3 gap-2 items-center">
                    ...
                    <div className="flex flex-col gap-2 items-start">
                      <label className="block font-bold mt-4">
                        If Edema, Swelling Duration (days):
                      </label>
                      <input
                        type="number"
        ...
        >
          {isSaved && (
            <motion.button
              ...
              className="bg-blue-600 text-white px-8 py-2 rounded-md hover:bg-blue-700 focus:outline-none"
            >
          ...
          <motion.button
            ...
            className="bg-blue-800 text-white px-8 py-2 rounded-md hover:bg-blue-700 focus:outline-none"
          >
