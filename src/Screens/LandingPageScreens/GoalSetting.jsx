...
const GoalSetting = () => {
  ...
  return (
    ...
    <h2 className="text-2xl font-bold text-gray-800  mb-8">Create Patient Profile</h2>
      ...
      <div className=" mx-auto bg-white rounded-lg">
              ...
              <form className='flex flex-col gap-4'>
                <div className='grid grid-cols-3 gap-8 items-start'>
                  ...
                  <div className='flex flex-col gap-2'>
                    <label className="block font-bold">Weight Gain Target</label>
                    <input
                      type="number"
                      name="weightGainTarget"
                      value={goals.weightGainTarget}
                      onChange={(e) => handleInputChange('weightGainTarget', e.target.value)}
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('weightGainPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.weightRecovery}
                    >
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('weightGainAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.weightRecovery}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('weightGainAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.weightRecovery}
                    >
                      <option value="day">Day</option>
                  ...
                  {/* Weight-for-Height */}
                  <div className='flex flex-col gap-2'>
                    <label className="block font-bold">Weight-for-Height</label>
                    <input
                      type="number"
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('weightForHeightPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.weightRecovery}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('weightForHeightAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.weightRecovery}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('weightForHeightAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.weightRecovery}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('initialMuac', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.weightRecovery}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('initialMuacPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.weightRecovery}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('initialMuacAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.weightRecovery}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('initialMuacAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.weightRecovery}
                    >
                      <option value="day">Day</option>
            ...
            <div className="container mx-auto w-full bg-white rounded-lg shadow-md px-8 py-2 my-2">
              <form className='flex flex-col gap-4'>
                <div className='grid grid-cols-3 gap-8 items-start'>
                  {/* Hemoglobin Level */}
                  <div className='flex flex-col gap-2'>
                    <label className="block font-bold">Hemoglobin Level</label>
                    <input
                      type="number"
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('hemoglobinPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('hemoglobinAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('hemoglobinAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('zincPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('zincAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('zincAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('vitaminDPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('vitaminDAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('vitaminDAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    >
                      <option value="day">Day</option>
                ...
                <div className='grid grid-cols-3 gap-8 items-start'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('ironPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('ironAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('ironAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('vitaminAPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('vitaminAAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('vitaminAAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.micronutrient}
                    >
                      <option value="day">Day</option>
                ...
                <div className='grid grid-cols-4 gap-8 items-start'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('dehydration', e.target.value)}
                      className="w-full p-2 border rounded"
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('dehydrationPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.hydration}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('dehydrationAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.hydration}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('dehydrationAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.hydration}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('potassiumPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.hydration}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('potassiumAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.hydration}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('potassiumAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.hydration}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('chloridePeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.hydration}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('chlorideAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.hydration}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('chlorideAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.hydration}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('sodiumPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.hydration}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('sodiumAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.hydration}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('sodiumAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.hydration}
                    >
                      <option value="day">Day</option>
                ...
                <div className='grid grid-cols-3 gap-8 items-start'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('edemaPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('edemaAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('edemaAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('lethargy', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('lethargyPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('lethargyAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('lethargyAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('skinLesions', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('skinLesionsPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('skinLesionsAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('skinLesionsAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    >
                      <option value="day">Day</option>
                ...
                <div className='grid grid-cols-3 gap-8 items-start'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <input
                      ...
                      name="others1"
                      value={goals.others1}
                      onChange={(e) => handleInputChange('others1', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('others1Period', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('others1Alert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('others1AlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <input
                      ...
                      name="others2"
                      value={goals.others2}
                      onChange={(e) => handleInputChange('others2', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('others2Period', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('others2Alert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('others2AlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.clinicalSymptoms}
                    >
                      <option value="day">Day</option>
                ...
                <div className='grid grid-cols-3 gap-8 items-start'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('appetiteLevel', e.target.value)}
                      className="w-full p-2 border rounded"
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('appetitePeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.developmental}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('appetiteAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.developmental}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('appetiteAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.developmental}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('activityPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.developmental}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('activityAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.developmental}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('activityAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.developmental}
                    >
                      <option value="day">Day</option>
            ...
            <div className="container mx-auto w-full bg-white rounded-lg shadow-md px-8 py-2 my-2">
              <form className='flex flex-col gap-4'>
                <div className='grid grid-cols-3 gap-8 items-start'>
                  ...
                  <div className='flex flex-col gap-2'>
                    <label className="block font-bold">Caregiver Understanding</label>
                    <input
                      type="number"
                      name="caregiverUnderstanding"
                      value={goals.caregiverUnderstanding}
                      onChange={(e) => handleInputChange('caregiverUnderstanding', e.target.value)}
                      className="w-full p-2 border rounded"
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('caregiverUnderstandingPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.education}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('caregiverUnderstandingAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.education}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('caregiverUnderstandingAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.education}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    <label className="block font-bold">Appointment Attendance</label>
                    <input
                      type="number"
                      name="appointmentAttendance"
                      value={goals.appointmentAttendance}
                      onChange={(e) => handleInputChange('appointmentAttendance', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.education}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('appointmentAttendancePeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.education}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('appointmentAttendanceAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.education}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('appointmentAttendanceAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.education}
                    >
                      <option value="day">Day</option>
            ...
            <div className="container mx-auto w-full bg-white rounded-lg shadow-md px-8 py-2 my-2">
              <form className='flex flex-col gap-4'>
                <div className='grid grid-cols-3 gap-8 items-start'>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('weightPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('weightAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('weightAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('heightPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('heightAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('heightAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    >
                      <option value="day">Day</option>
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('muacPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('muacAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('muacAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    >
                      <option value="day">Day</option>
                ...
                <div className='grid grid-cols-3 gap-8 items-start'>
                  ...
                  <div className='flex flex-col gap-2'>
                    <label className="block font-bold">Signs of Malnutrition</label>
                    <input
                      type="text"
                      name="signsOfMalnutrition"
                      value={goals.signsOfMalnutrition}
                      onChange={(e) => handleInputChange('signsOfMalnutrition', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('signsOfMalnutritionPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    >
                      <option value="day">Day</option>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('signsOfMalnutritionAlert', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    />
                    <label className="block text-sm mt-2">Per</label>
                    <select
                      ...
                      onChange={(e) => handleInputChange('signsOfMalnutritionAlertPeriod', e.target.value)}
                      className="w-full p-2 border rounded"
                      disabled={!isEditing.longTerm}
                    >
                      <option value="day">Day</option>
        ...
        <div className="mt-8 flex justify-end">
          <button
            onClick={handleSave}
            className="bg-green-600 text-white px-8 py-3 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors"
          >
            Save All Goals
          </button>
        </div>
